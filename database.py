...
class Database:
    ...
    def select(self, columns: str, table_name: str, uslovie: str = None, JSON: bool = True):
        ...
        quire = f'SELECT {columns} FROM {table_name}' + (f' WHERE {uslovie}' if uslovie else '') + ';'
